...
const registerUser = asyncHandler(async (req, res) => {
    let { 
        ...
        dob, gender, height, weight, unit, goals, activityLevel, bio, pushNotifications 
    } = req.body
    ...
    let avatar = { secure_url: "https://res.cloudinary.com/demo/image/upload/v1589408544/avatar.png" };
    if (avatarLocalPath) {
        const uploadedAvatar = await uploadOnCloud(avatarLocalPath);
    ...
    const user = await User.create({
        ...
        activityLevel,
        bio,
        pushNotifications: pushNotifications === 'false' ? false : true
    })
...
const getCurrentUser = asyncHandler(async (req, res) => {
    return res
        ...
        .json(new ApiResponse(200, { 
            user: req?.user,
            acessToken: req.cookies?.acessToken || req.header("Authorization")?.replace("Bearer ", "")
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    const { fullname, username, age, weight, height } = req.body
